...
Route::post('/getCardFile', [FilesController::class, 'getCardFile'])->middleware('auth:sanctum');
Route::post('/getCardDrugSens', [FilesController::class, 'getCardDrugSens'])->middleware('auth:sanctum');
