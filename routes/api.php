...
Route::post('/addCardFile', [FilesController::class, 'getCardFile'])->middleware('auth:sanctum');
Route::post('/addCardDrugSens', [FilesController::class, 'getCardDrugSens'])->middleware('auth:sanctum');
