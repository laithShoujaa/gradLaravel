...
Route::post('/getCardFile', [CardsController::class, 'getCardFile'])->middleware('auth:sanctum');
Route::post('/getCardDrugSens', [CardsController::class, 'getCardDrugSens'])->middleware('auth:sanctum');
